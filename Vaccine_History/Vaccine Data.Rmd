...
vaccinecounty <- rio::import("/Users/rswells/Dropbox/Classes/Data Fall 2020/ArkansasCovid/Vaccine_Brief_ADH_2021_04_19.xlsx", skip=3, col_names = c("county", "partial_vax", "partialpct", "full_vax", "fullpct", "unknown_dose", "unknownpct", "population"))
...
```{r}
date <- Sys.Date()
save(vaccinecounty2,file=paste0("vaccinecounty2_",date,".csv"))
